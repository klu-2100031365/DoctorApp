...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      ...
      <p className='sm:w-1/3 text-center text-sm' >Connecting you with trusted doctors for quality care. Choose your specialist, check availability, and book your slot instantly </p>
